...
func (s *Server) Router() http.Handler {
	...
	mux.HandleFunc("POST /api/channels/{id}/leave", s.requireAuth(s.handleLeaveChannel))
	mux.HandleFunc("POST /api/dm", s.requireAuth(s.handleCreateDM))
	mux.HandleFunc("POST /api/communities", s.requireAuth(s.handleCreateCommunity))
